...
<html>
    ...
    <body>
        ...
        <div id="show-eleve" class="content scaffold-show" role="main">
            ...
            <f:display bean="eleve" />
            <g:form resource="${this.eleve}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.eleve}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
