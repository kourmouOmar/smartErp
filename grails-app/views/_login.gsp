    <div class="container-fluid page-body-wrapper full-page-wrapper" >
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow" style="padding:0px !important">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                    <asset:image src="images/logo.svg" alt="logo"/>
              </div>
              <h4>Welcome back!</h4>
              <h6 class="font-weight-light">Happy to see you again!</h6>
              <g:form class="pt-3" action="auth" controller="index">
                ...
                <div class="my-3">
                    <input type="submit" name="ok" value="Envoye" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"/>
                </div>
