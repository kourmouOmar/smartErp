...
<html>
    ...
    <body>
        ...
        <div id="show-professeur" class="content scaffold-show" role="main">
            ...
            <f:display bean="professeur" />
            <g:form resource="${this.professeur}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.professeur}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
