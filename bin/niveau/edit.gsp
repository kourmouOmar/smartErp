...
<html>
    ...
    <body>
        ...
        <div id="edit-niveau" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.niveau}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.niveau}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.niveau}" method="PUT">
                <g:hiddenField name="version" value="${this.niveau?.version}" />
                <fieldset class="form">
                    <f:all bean="niveau"/>
                </fieldset>
