...
<html>
    ...
    <body>
        ...
        <div id="show-niveau" class="content scaffold-show" role="main">
            ...
            <f:display bean="niveau" />
            <g:form resource="${this.niveau}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.niveau}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
