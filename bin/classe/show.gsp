...
<html>
    ...
    <body>
        ...
        <div id="show-classe" class="content scaffold-show" role="main">
            ...
            <f:display bean="classe" />
            <g:form resource="${this.classe}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.classe}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
