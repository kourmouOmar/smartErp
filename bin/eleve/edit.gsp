...
<html>
    ...
    <body>
        ...
        <div id="edit-eleve" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.eleve}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.eleve}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.eleve}" method="PUT">
                <g:hiddenField name="version" value="${this.eleve?.version}" />
                <fieldset class="form">
                    <f:all bean="eleve"/>
                </fieldset>
