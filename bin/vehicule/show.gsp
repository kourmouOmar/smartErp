...
<html>
    ...
    <body>
        ...
        <div id="show-vehicule" class="content scaffold-show" role="main">
            ...
            <f:display bean="vehicule" />
            <g:form resource="${this.vehicule}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vehicule}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
