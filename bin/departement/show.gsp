...
<html>
    ...
    <body>
        ...
        <div id="show-departement" class="content scaffold-show" role="main">
            ...
            <f:display bean="departement" />
            <g:form resource="${this.departement}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.departement}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
